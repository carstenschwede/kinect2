...
Kinect2.prototype.openFaceReader = function() {
	return this.nativeKinect2.openFaceReader();
};

Kinect2.prototype.closeFaceReader = function() {
	return this.nativeKinect2.closeFaceReader();
};
...
Kinect2.prototype.openAudioBeamReader = function() {
	return this.nativeKinect2.openAudioBeamReader(this.audioBeamFrameCallback);
};

Kinect2.prototype.closeAudioBeamReader = function() {
	return this.nativeKinect2.closeAudioBeamReader();
};
...
Kinect2.prototype.audioBeamFrameCallback = function(data) {
	self.emit('audioBeamFrame', data);
};
